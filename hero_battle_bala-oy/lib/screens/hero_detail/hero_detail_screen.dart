      ...
      body: Container(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            if (hero.storyline.trim().isNotEmpty)
              const SizedBox(height: 16),
            if (hero.storyline.trim().isNotEmpty)
              Card(
                elevation: 0,
                  ...
                  children: <Widget>[
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final combatStats = <_HeroStatEntry>[
                          _HeroStatEntry(label: 'Max HP', value: hero.maxHp),
                          _HeroStatEntry(label: 'Max Mana', value: hero.maxMana),
                          _HeroStatEntry(label: 'Attack', value: hero.attack),
                          _HeroStatEntry(label: 'Defense', value: hero.defense),
                        ];
                        return Wrap(
                          spacing: 12,
                          runSpacing: 12,
                          children: combatStats
                              .map(
                                (entry) => SizedBox(
                                  width: tileWidth,
                                  child: _CombatStatTile(
                                    label: entry.label,
                                    value: entry.value,
