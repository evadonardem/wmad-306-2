...
class DatabaseService {
  ...
  Future<int> saveOrUpdateDeck(String name, List<HeroModel> heroes) async {
    final db = await database;
  ...
  Future<int> updateDeckName(int id, String name) async {
    final db = await database;
    return db.update(
      'decks',
      {'name': name},
  ...
  Future<Map<String, dynamic>?> loadDeckByName(String name) async {
    final db = await database;
