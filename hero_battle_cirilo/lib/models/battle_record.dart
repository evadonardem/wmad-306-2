class BattleRecord {
  ...
  String get attackerName => playerHero;
  String get defenderName => aiHero;
  String get winnerName => playerWon ? playerHero : aiHero;
  String get summary => playerWon
      ? '$playerHero defeated $aiHero in $roundsPlayed round${roundsPlayed == 1 ? '' : 's'}.'
      : '$aiHero defeated $playerHero in $roundsPlayed round${roundsPlayed == 1 ? '' : 's'}.';
  DateTime get timestamp => DateTime.parse(playedAt);
