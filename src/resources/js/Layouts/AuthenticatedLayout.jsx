            ...
            >
                    ...
                    <div className="flex h-16 justify-between">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('app.tasks')} active={route().current('app.tasks')}>
                                    Tasks
                                </NavLink>
                            </div>
                        </div>
                        ...
                        <div className="hidden sm:ms-6 sm:flex sm:items-center">
                            <div className="relative ms-3">
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            ...
                                            >
                                                ...
                                                <svg
                                                    className="-me-0.5 ms-2 h-4 w-4 text-white/70"
                                    ...
                                    <Dropdown.Content>
                                        {/* ✅ FIX ONLY: force dropdown items to dark text (override nav white rules) */}
                                        <div
                                            className="
                                                bg-white
                                                [&_a]:!text-gray-800
                                                [&_a:hover]:!text-gray-900
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="space-y-1 pb-3 pt-2">
                        ...
                        <ResponsiveNavLink href={route('app.tasks')} active={route().current('app.tasks')}>
                            Tasks
                        </ResponsiveNavLink>
                    </div>

                    <div className="border-t border-[rgba(255,255,255,0.10)] pb-1 pt-4">
                        <div className="px-4">
