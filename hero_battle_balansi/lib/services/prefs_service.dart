// Manual §5.2 — SharedPreferences wrapper. No other file in the app
// imports `package:shared_preferences/...` directly (see rubric §9).
...
class PrefsService {
  ...
  /// Defaults to true so the Neon Noir dark theme is active on first launch.
