...
class SuperheroApiService {
  ...
  /// NEW: Fetch ALL heroes from the static Akabab JSON API.
  /// This is much faster for global sorting and discovery.
  Future<List<HeroModel>> fetchAllHeroes() async {
    try {
      final response = await _dio.get('https://akabab.github.io/superhero-api/api/all.json');
